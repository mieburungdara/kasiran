    ...
    <div class="card-body">
        <?php echo form_open('admin/kategori/tambah'); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control <?php echo form_error('nama_kategori') ? 'is-invalid' : ''; ?>" id="nama_kategori" name="nama_kategori" value="<?php echo set_value('nama_kategori'); ?>" required autofocus>
